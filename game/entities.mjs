...
export const EntityFactory = {
    buildings: {
        createBase: function(x, y, idContainer) {
            const entity = new Entity(idContainer);

            entity.components.set(Components.Bounds, new Components.Bounds(x, y, 3, 3));
            entity.components.set(Components.Currency, new Components.Currency(0, ResourceType.GOLD));
        ...
        createMine: function(x, y, idContainer) {
            ...
            entity.components.set(Components.Hp, new Components.Hp(20));
